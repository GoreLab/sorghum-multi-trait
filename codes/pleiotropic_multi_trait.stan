...
data {
  ...
  // Feature matrices:
  matrix[n_x_0, p_x_0] X_0;
  matrix[n_x_0, p_r_0] X_r_0;
  ...
  // Feature matrices:
  matrix[n_x_1, p_x_1] X_1;
  matrix[n_x_1, p_r_1] X_r_1;
...
transformed parameters {
  ...
  expectation_0 = mu_0 + X_0 * (beta_0 + eta);

  // Computing the vectorized vector of residuals:
  sigma_vec_1 = X_r_1 * sigma_1;

  // Computing the expectation of the likelihood function:
  expectation_1 = mu_1 + X_1 * (beta_1 + eta);
