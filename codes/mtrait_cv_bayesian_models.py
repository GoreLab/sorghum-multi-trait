...
if model=='DBN':
  ...
  if cv == 'CV1':
    df_stan = dict(n_0 = y['30_trn'].size,
                   p_x_0 = X['30_nobin_trn'].drop('dap',axis=1).shape[1],
                   p_z = X['30_bin_trn'].shape[1],
                   ...
                   n_1 = y['45_trn'].size,
                   p_x_1 = X['45_nobin_trn'].drop('dap',axis=1).shape[1],
                   ...
                   n_2 = y['60_trn'].size,
                   p_x_2 = X['60_nobin_trn'].drop('dap',axis=1).shape[1],
                   ...
                   n_3 = y['75_trn'].size,
                   p_x_3 = X['75_nobin_trn'].drop('dap',axis=1).shape[1],
                   ...
                   n_4 = y['90_trn'].size,
                   p_x_4 = X['90_nobin_trn'].drop('dap',axis=1).shape[1],
                   ...
                   n_5 = y['105_trn'].size,
                   p_x_5 = X['105_nobin_trn'].drop('dap',axis=1).shape[1],
                   ...
                   n_6 = y['120_trn'].size,
                   p_x_6 = X['120_nobin_trn'].drop('dap',axis=1).shape[1],
