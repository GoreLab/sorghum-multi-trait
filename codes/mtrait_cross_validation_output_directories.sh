...
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-30~only;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-30~only/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-30~only/drymass-height/k0;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-30~only/drymass-height/k1;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-30~only/drymass-height/k2;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-30~only/drymass-height/k3;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-30~only/drymass-height/k4;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-45~only;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-45~only/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-45~only/drymass-height/k0;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-45~only/drymass-height/k1;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-45~only/drymass-height/k2;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-45~only/drymass-height/k3;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-45~only/drymass-height/k4;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-60~only;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-60~only/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-60~only/drymass-height/k0;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-60~only/drymass-height/k1;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-60~only/drymass-height/k2;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-60~only/drymass-height/k3;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-60~only/drymass-height/k4;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-75~only;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-75~only/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-75~only/drymass-height/k0;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-75~only/drymass-height/k1;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-75~only/drymass-height/k2;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-75~only/drymass-height/k3;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-75~only/drymass-height/k4;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-90~only;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-90~only/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-90~only/drymass-height/k0;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-90~only/drymass-height/k1;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-90~only/drymass-height/k2;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-90~only/drymass-height/k3;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-90~only/drymass-height/k4;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-105~only;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-105~only/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-105~only/drymass-height/k0;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-105~only/drymass-height/k1;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-105~only/drymass-height/k2;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-105~only/drymass-height/k3;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv3-105~only/drymass-height/k4;
