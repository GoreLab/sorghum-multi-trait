...
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~45/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~60;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~60/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~75;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~75/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~90;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~90/drymass-height;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~105;
mkdir ${PREFIX}/outputs/cross_validation/PBN/cv2-30~105/drymass-height;
